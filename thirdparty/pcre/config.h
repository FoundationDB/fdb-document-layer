...
/*Make sure __attribute__ is not used in MSVS Build when source is directly included */
#if defined(_MSC_VER) && defined(PCRE_STATIC)
	#define __attribute__(unused) /*DO NOTHING*/
#else
#endif
